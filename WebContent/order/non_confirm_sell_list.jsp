...
<div id="page-contents">
	...
	<form name="frm">
		<div id="schkeyword">
			<p align="right">
				...
				<input type="text" name="keyword" id="pdt" placeholder="검색어를 입력해주세요." value="<%=keyword %>" />&nbsp;&nbsp;&nbsp;
	...
	<table width="1000" align="center" border="1" cellpadding="3" cellspacing="0">
		...
		if (rcnt > 0) {	// 검색된 상품 목록이 있을 경우
			String lnk = "non_confirm_sell_list?cpage=";
		...
		if (cpage == 1) {
			...
			out.print("<a href=\"non_confirm_sell_list?cpage=1" + tmp + "\">");
			out.println("[&lt;&lt;]</a>&nbsp;&nbsp;");
			out.print("<a href=\"non_confirm_sell_list?cpage=" + (cpage - 1) + tmp + "\">");
			out.println("[&lt;]</a>&nbsp;");
		}
		...
		for (int i = 1, j = spage ; i < bsize && j <= pcnt ; i++, j++) {
			if (cpage == j) {
				...
				out.print("&nbsp;<a href=\"non_confirm_sell_list?cpage=");
		...
		if (cpage == pcnt) {
			...
			out.print("&nbsp;<a href=\"non_confirm_sell_list?cpage=" + (cpage + 1) + tmp + "\">");
			out.println("[&gt;]</a>&nbsp;&nbsp;");
			out.print("<a href=\"non_confirm_sell_list?cpage=" + pcnt + tmp + "\">");
			out.println("[&gt;&gt;]</a>");
		}
			out.println("</p>");
